...
RUN apt-get -y update && apt-get -y upgrade && apt-get -y install openjdk-8-jdk-headless openjdk-8-jre-headless python3 python3-jenkins python3-pip vim sudo git curl chromium-browser ssh
